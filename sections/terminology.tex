...
therefore also the inquiry language \oracle: 
...
where \textbf{P} is a countable set of atomic propositions and $p \in
	\mathbf{P}$, $\oracle$ is the entity representing factual information i.e. common knowledge

\begin{table}[t]
	\caption{Notional Schema}
	\begin{tabularx}{\linewidth}{p{0.40\linewidth}X}
		\toprule
		
		\multicolumn{2}{l}{{\underline{Formulas: }}}                                       \\
...
a fact, the negation of a proposition or the conjunction of propositions. \oracle should be perceived as being the source of common knowledge between agents, and therefore also do not have any notion of which agents know what, or any distinguish-ability between worlds.
