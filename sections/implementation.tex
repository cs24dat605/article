...
\begin{figure}[H]
	...
	\scalebox{0.8}{
		\begin{tikzpicture}
			...
			\end{class}
			\begin{class}[text width=4.5cm]{Agent    Me    Self}{5,1.2}
			...
			\end{class}
			\unidirectionalAssociation{Game}{1..*}{}{Agent    Me    Self}{}{}
			\unidirectionalAssociation{Agent    Me    Self}{1..*}{}{World}{}{}
		\end{tikzpicture}}
	\vspace*{3mm}
...
implementation facts are is aquired as soon as an action has occured. This
change does not affect the game, as all agents already have declared which
night action they want to take. As facts are revealed, possible-worlds are
removed, meaning that one may slowly infer the roles of other agents.
