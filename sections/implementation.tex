...
\begin{figure}[H]
	...
	\scalebox{0.8}{
		\begin{tikzpicture}
			\begin{class}[text width= 3cm]{Game}{-1,0}
...
\begin{algorithm}[H]
	...
	\begin{algorithmic}[1]
		...
		\ForAll{a $in$ game.Agents}
		\ForAll{possWorld $in$ a.possWorlds}
