...
a list of all agents that he has checked, such that he does not check a agent
twice.
...
meaning that one may slowly infer the roles of agents while not knowing their
