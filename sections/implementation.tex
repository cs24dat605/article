...
that the worlds that are not in accordance with the new information are inactive. 
This is corresponds to the model update defined in \cref{eq:5}. An agent dying is the way that most roles
