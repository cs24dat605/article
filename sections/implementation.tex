...
A game consists of some $n$ number of agents, wherein each agent has $m$ amount of worlds, where $m$ is the result of \cref{eq:numofworlds}.
...
\begin{figure}[H]
	...
	\scalebox{0.8}{
		\begin{tikzpicture}
			...
			\end{class}
			\begin{class}[text width=4.5cm]{Agent}{5,-0.2}
