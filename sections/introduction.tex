...
analysed consist mainly of two types: information- gatherers and deniers\todo{is this the correct way to do this}. Through this analysis we will be able to draw a general conclusion on
...
decision-making strategies that can be implemented in multi-agent systems, which
